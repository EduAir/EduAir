            ...
            <div class="ask_camera_enabled">
                <center>
                    ...
                    <a href="#!" class="waves-effect waves-green btn-flat have_smile" reason="end_call"><?php echo $this->lang->line('form_close'); ?></a>
                </center>
            </div>
            
            <div class="row pilot controler" style="display:none;">
                <div class="col s6"><center><a class="btn-floating btn-large waves-effect waves-light have_smile orange" reason="statu_cam" statu_cam="on"><i class="cam_state mdi-av-videocam-off"></i></a></center></div>
                <div class="col s6"><center><a class="btn-floating btn-large waves-effect waves-light have_smile red"    reason="end_call"><i class="mdi-notification-phone-missed"></i></a></center></div>
            </div>
